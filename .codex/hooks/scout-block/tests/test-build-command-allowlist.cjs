...
const tests = [
  ...
  // Backend framework CLIs - should be allowed (the nest build bug fix)
  { cmd: 'nest build', expected: true, desc: 'nest build' },
  { cmd: 'nest start', expected: true, desc: 'nest start' },
  { cmd: 'nest generate module users', expected: true, desc: 'nest generate' },
  { cmd: 'prisma migrate dev', expected: true, desc: 'prisma migrate' },
  { cmd: 'drizzle-kit generate', expected: true, desc: 'drizzle-kit generate' },
  { cmd: 'rails server', expected: true, desc: 'rails server' },
  { cmd: 'php artisan migrate', expected: true, desc: 'php artisan (via php)' },

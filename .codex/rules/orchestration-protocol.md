...
When spawning subagents via Codex subagent workflow, **ALWAYS** include in prompt:
...
For multi-session parallel collaboration, coordinate agents manually via the orchestration patterns above.

...
function Get-RemediationCommands {
    ...
    if ($hasPythonFailed) {
        ...
        Write-Host ".\.agents\skills\.venv\Scripts\Activate.ps1"
...
function Write-ErrorSummary {
    ...
    $summary = @{
        ...
        remediation = @{
            ...
            pip_retry = ".\.agents\skills\.venv\Scripts\Activate.ps1; python -m pip install `"<package>`""
        }
    }
...
function Show-Usage {
    ...
    Write-Host "  .agents\skills\INSTALLATION.md"
    Write-Host ""
}

# Show help
function Show-Help {
    Write-Host "Codex skills Installation Script for Windows"
    Write-Host ""
    Write-Host "Usage:"
...
function Main {
    ...
    Write-Header "Codex skills Installation (Windows)"

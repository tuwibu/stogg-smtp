...
- Active pointer: `.codex/workflow-artifacts.json`
...
```json
{
  ...
  "touchpoints": [".codex/hooks/workflow-artifact-gate.cjs"],
  "publicContracts": ["manual command: node .codex/hooks/workflow-artifact-gate.cjs --stage finalize --artifact-dir <dir>"],
  "blastRadius": ["Codex hook execution", "fix/cook review cycle"],

 ...
 * Run: node .agents/skills/_shared/tests/plan-table-parser.test.cjs
 */
...
// ============================================================
// M8: Tests merged from unit test file (.agents/skills/_shared/lib/__tests__/plan-table-parser.test.cjs)

...
5. **Log** — append to `plans/reports/security-audit-<YYMMDD-HHmm>.tsv` (gitignored — it is a full
   inventory of unpatched vulns; never write it to the repo root, never commit it) with persona column

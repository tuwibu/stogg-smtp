...
> **Policy first:** Branches are NOT created automatically. Default is to work on the main branch
> (`main`/`master`). Create a branch ONLY when the user explicitly asks, and ask for the name via
> `AskUserQuestion` before creating. See `.codex/rules/branch-policy.md`. The conventions below apply
> **once a branch has been sanctioned** — they seed the candidate names offered to the user, they do
> not authorize auto-creation.

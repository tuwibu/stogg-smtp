...
When reviewing rendered output for collisions or unreadable labels, apply standard SVG layout rules (component spacing, arrow routing, label placement, z-index ordering).

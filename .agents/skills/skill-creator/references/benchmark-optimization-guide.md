...
- **Workflow steps** — Numbered, deterministic sequences Codex follows
- **Error handling** — Cover edge cases so Codex doesn't skip concepts
...
- Skill MUST teach Codex to refuse out-of-scope requests explicitly
...
- **No scope boundaries** — Codex attempts off-topic requests → low refusal

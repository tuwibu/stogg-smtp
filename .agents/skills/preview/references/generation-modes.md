...
For full SVG layout rules (spacing minimums, arrow connection points, z-index ordering, anti-pattern catalog), apply the general rules above iteratively until visually clean.

## Step 3: Save and Preview

1. Write generated content to determined path
2. Open the generated file in the user's default browser or instruct the user to open it directly.

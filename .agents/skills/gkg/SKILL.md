---
name: gkg
description: "Semantic code analysis with GitLab Knowledge Graph. Use for go-to-definition, find-usages, impact analysis, architecture/dependency visualization. Supports Ruby, Java, Kotlin, Python, TypeScript/JavaScript."
user-invocable: true
when_to_use: "Invoke to navigate code like an IDE — find usages, go-to-definition, impact analysis, or draw architecture/dependency graphs."
category: dev-tools
keywords: [knowledge-graph, code-analysis, go-to-definition, find-usages, impact-analysis, ast, kuzudb]
argument-hint: "[symbol or query]"
related: [graphify, repomix, scout]
maturity: beta
metadata:
  author: claudekit
  version: "1.0.0"
...
**Use `graphify` instead** for: a self-contained queryable knowledge graph (no external CLI, broader inputs — docs/papers/images).
**Use `scout` instead** for: fast file discovery and a plain directory tree.
